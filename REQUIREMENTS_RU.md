...
- При невалидном результате допускается ровно одна техническая повторная
  ...
  только известные source placeholders, candidate всё равно публикуется: все
  присутствующие placeholders восстанавливаются, а потерянные fragments остаются
  отсутствующими. Такой перевод получает RED без critic repair этого дефекта.
  ...
  нарушения контракта остаются терминальными до публикации.
