...
подписи: `[[YDBDOC_PROTECTED_0001]]label[[YDBDOC_PROTECTED_0002]]`. Первая граница
восстанавливает начало конструкции, вторая восстанавливает её окончание с
destination. Модель
переводит label, но не видит URL и не может незаметно объединить соседние ссылки:
точное наличие, порядок и раздельность обеих пар проверяются до восстановления.
