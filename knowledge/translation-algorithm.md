...
исходными fragments, candidate повторно разбирается как Markdown/YFM и
проверяется на совместимость структуры. Невалидный ответ получает не более одной
технической попытки исправления с конкретной ошибкой валидатора. При `doc_verify`
