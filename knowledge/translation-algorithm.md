...
исправления с конкретной ошибкой валидатора. Если большой translate chunk снова
невалиден, он может один раз разделиться по безопасной границе верхнеуровневых
блоков; дочерние chunks рекурсивно не делятся. При `doc_verify`
